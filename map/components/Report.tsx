...
// ── Main Report ───────────────────────────────────────────────────────────────
// takes: the report payload, plus hideToc when rendered inside a workspace card
// does: renders the full sector report; hideToc suppresses the viewport-fixed
//       "Contents" rail, which would overlap content when the report is not
//       the whole page
// returns: the report element
export default function Report({ data: rawInput, hideToc = false }: { data: any; hideToc?: boolean }) {
